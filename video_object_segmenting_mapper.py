...
class VideoObjectSegmentingMapper(Mapper):
    ...
    def __init__(
        ...
        if_return_segment_data: bool = True,
        ...
        **kwargs,
        ...
        :param if_return_segment_data: Whether to return segment_data in output.
        ...
        self.sam2_model_key = prepare_model(
            ...
            pretrained_model_name_or_path=sam2_hf_model,
        )
        ...
        self.if_return_segment_data = if_return_segment_data

    def _empty_result(self) -> dict[str, Any]:
        return {
            "segment_data": [] if self.if_return_segment_data else None,
            "cls_id_dict": [],
            "object_cls_list": [],
            "yoloe_conf_list": [],
            "yoloe_bbox_list": [],
    ...
    def process_single(self, sample=None, rank=None):
        ...
        sam2_model, sam2_processor = get_model(
            model_key=self.sam2_model_key,
            rank=rank,
        ...
        yoloe_model = get_model(
            model_key=self.yoloe_model_key,
            rank=rank,
            use_cuda=self.use_cuda(),
        )
        ...
        _ = sam2_processor.post_process_masks(
            [outputs.pred_masks],
        ...
        if self.if_save_visualization:
            ...
            for temp_frame_masks_id, temp_frame_masks in enumerate(video_segments):
